...
func TestDaytenMovment(t *testing.T) {
	var tests = []struct {
		direction Direction
		from      int
		to        int
		...
		{LEFT, PIPE_HORIZONTAL, PIPE_HORIZONTAL, true},
		{LEFT, PIPE_HORIZONTAL, PIPE_VERTICAL, false},
		{LEFT, PIPE_HORIZONTAL, BEND_L, true},
		{LEFT, PIPE_HORIZONTAL, BEND_J, false},
		{LEFT, PIPE_HORIZONTAL, BEND_7, false},
		{LEFT, PIPE_HORIZONTAL, BEND_F, true},
		{LEFT, PIPE_HORIZONTAL, GROUND, false},
		{LEFT, PIPE_HORIZONTAL, STARTING_POS, false},
		{LEFT, PIPE_VERTICAL, PIPE_VERTICAL, false},
		{LEFT, PIPE_VERTICAL, PIPE_HORIZONTAL, false},
		{LEFT, PIPE_VERTICAL, BEND_L, false},
		{LEFT, PIPE_VERTICAL, BEND_J, false},
		{LEFT, PIPE_VERTICAL, BEND_7, false},
		{LEFT, PIPE_VERTICAL, BEND_F, false},
		{LEFT, PIPE_VERTICAL, GROUND, false},
		{LEFT, PIPE_VERTICAL, STARTING_POS, false},
		{LEFT, BEND_L, PIPE_HORIZONTAL, false},
		{LEFT, BEND_L, PIPE_VERTICAL, false},
		{LEFT, BEND_L, BEND_L, false},
		{LEFT, BEND_L, BEND_J, false},
		{LEFT, BEND_L, BEND_7, false},
		{LEFT, BEND_L, BEND_F, false},
		{LEFT, BEND_L, GROUND, false},
		{LEFT, BEND_L, STARTING_POS, false},
		{LEFT, BEND_J, PIPE_HORIZONTAL, true},
		{LEFT, BEND_J, PIPE_VERTICAL, false},
		{LEFT, BEND_J, BEND_L, true},
		{LEFT, BEND_J, BEND_J, false},
		{LEFT, BEND_J, BEND_7, false},
		{LEFT, BEND_J, BEND_F, true},
		{LEFT, BEND_J, GROUND, false},
		{LEFT, BEND_J, STARTING_POS, false},
		{LEFT, BEND_7, PIPE_HORIZONTAL, true},
		{LEFT, BEND_7, PIPE_VERTICAL, false},
		{LEFT, BEND_7, BEND_L, true},
		{LEFT, BEND_7, BEND_J, false},
		{LEFT, BEND_7, BEND_7, false},
		{LEFT, BEND_7, BEND_F, true},
		{LEFT, BEND_7, GROUND, false},
		{LEFT, BEND_7, STARTING_POS, false},
		{LEFT, BEND_F, PIPE_HORIZONTAL, false},
		{LEFT, BEND_F, PIPE_VERTICAL, false},
		{LEFT, BEND_F, BEND_L, false},
		{LEFT, BEND_F, BEND_J, false},
		{LEFT, BEND_F, BEND_7, false},
		{LEFT, BEND_F, BEND_F, false},
		{LEFT, BEND_F, GROUND, false},
		{LEFT, BEND_F, STARTING_POS, false},
		{LEFT, GROUND, PIPE_HORIZONTAL, false},
		{LEFT, GROUND, PIPE_VERTICAL, false},
		{LEFT, GROUND, BEND_L, false},
		{LEFT, GROUND, BEND_J, false},
		{LEFT, GROUND, BEND_7, false},
		{LEFT, GROUND, BEND_F, false},
		{LEFT, GROUND, GROUND, false},
		{LEFT, GROUND, STARTING_POS, false},
		{LEFT, STARTING_POS, PIPE_HORIZONTAL, true},
		{LEFT, STARTING_POS, PIPE_VERTICAL, false},
		{LEFT, STARTING_POS, BEND_L, true},
		{LEFT, STARTING_POS, BEND_J, false},
		{LEFT, STARTING_POS, BEND_7, false},
		{LEFT, STARTING_POS, BEND_F, true},
		{LEFT, STARTING_POS, GROUND, false},
		{LEFT, STARTING_POS, STARTING_POS, false},
		{UP, PIPE_HORIZONTAL, PIPE_HORIZONTAL, false},
		{UP, PIPE_HORIZONTAL, PIPE_VERTICAL, false},
		{UP, PIPE_HORIZONTAL, BEND_L, false},
		{UP, PIPE_HORIZONTAL, BEND_J, false},
		{UP, PIPE_HORIZONTAL, BEND_7, false},
		{UP, PIPE_HORIZONTAL, BEND_F, false},
		{UP, PIPE_HORIZONTAL, GROUND, false},
		{UP, PIPE_HORIZONTAL, STARTING_POS, false},
		{UP, PIPE_VERTICAL, PIPE_VERTICAL, true},
		{UP, PIPE_VERTICAL, PIPE_HORIZONTAL, false},
		{UP, PIPE_VERTICAL, BEND_L, false},
		{UP, PIPE_VERTICAL, BEND_J, false},
		{UP, PIPE_VERTICAL, BEND_7, true},
		{UP, PIPE_VERTICAL, BEND_F, true},
		{UP, PIPE_VERTICAL, GROUND, false},
		{UP, PIPE_VERTICAL, STARTING_POS, false},
		{UP, BEND_L, PIPE_HORIZONTAL, false},
		{UP, BEND_L, PIPE_VERTICAL, true},
		{UP, BEND_L, BEND_L, false},
		{UP, BEND_L, BEND_J, false},
		{UP, BEND_L, BEND_7, true},
		{UP, BEND_L, BEND_F, true},
		{UP, BEND_L, GROUND, false},
		{UP, BEND_L, STARTING_POS, false},
		{UP, BEND_J, PIPE_HORIZONTAL, false},
		{UP, BEND_J, PIPE_VERTICAL, true},
		{UP, BEND_J, BEND_L, false},
		{UP, BEND_J, BEND_J, false},
		{UP, BEND_J, BEND_7, true},
		{UP, BEND_J, BEND_F, true},
		{UP, BEND_J, GROUND, false},
		{UP, BEND_J, STARTING_POS, false},
		{UP, BEND_7, PIPE_HORIZONTAL, false},
		{UP, BEND_7, PIPE_VERTICAL, false},
		{UP, BEND_7, BEND_L, false},
		{UP, BEND_7, BEND_J, false},
		{UP, BEND_7, BEND_7, false},
		{UP, BEND_7, BEND_F, false},
		{UP, BEND_7, GROUND, false},
		{UP, BEND_7, STARTING_POS, false},
		{UP, BEND_F, PIPE_HORIZONTAL, false},
		{UP, BEND_F, PIPE_VERTICAL, false},
		{UP, BEND_F, BEND_L, false},
		{UP, BEND_F, BEND_J, false},
		{UP, BEND_F, BEND_7, false},
		{UP, BEND_F, BEND_F, false},
		{UP, BEND_F, GROUND, false},
		{UP, BEND_F, STARTING_POS, false},
		{UP, GROUND, PIPE_HORIZONTAL, false},
		{UP, GROUND, PIPE_VERTICAL, false},
		{UP, GROUND, BEND_L, false},
		{UP, GROUND, BEND_J, false},
		{UP, GROUND, BEND_7, false},
		{UP, GROUND, BEND_F, false},
		{UP, GROUND, GROUND, false},
		{UP, GROUND, STARTING_POS, false},
		{UP, STARTING_POS, PIPE_HORIZONTAL, false},
		{UP, STARTING_POS, PIPE_VERTICAL, true},
		{UP, STARTING_POS, BEND_L, false},
		{UP, STARTING_POS, BEND_J, false},
		{UP, STARTING_POS, BEND_7, true},
		{UP, STARTING_POS, BEND_F, true},
		{UP, STARTING_POS, GROUND, false},
		{UP, STARTING_POS, STARTING_POS, false},
		{RIGHT, PIPE_HORIZONTAL, PIPE_HORIZONTAL, true},
		{RIGHT, PIPE_HORIZONTAL, PIPE_VERTICAL, false},
		{RIGHT, PIPE_HORIZONTAL, BEND_L, false},
		{RIGHT, PIPE_HORIZONTAL, BEND_J, true},
		{RIGHT, PIPE_HORIZONTAL, BEND_7, true},
		{RIGHT, PIPE_HORIZONTAL, BEND_F, false},
		{RIGHT, PIPE_HORIZONTAL, GROUND, false},
		{RIGHT, PIPE_HORIZONTAL, STARTING_POS, false},
		{RIGHT, PIPE_VERTICAL, PIPE_VERTICAL, false},
		{RIGHT, PIPE_VERTICAL, PIPE_HORIZONTAL, false},
		{RIGHT, PIPE_VERTICAL, BEND_L, false},
		{RIGHT, PIPE_VERTICAL, BEND_J, false},
		{RIGHT, PIPE_VERTICAL, BEND_7, false},
		{RIGHT, PIPE_VERTICAL, BEND_F, false},
		{RIGHT, PIPE_VERTICAL, GROUND, false},
		{RIGHT, PIPE_VERTICAL, STARTING_POS, false},
		{RIGHT, BEND_L, PIPE_HORIZONTAL, true},
		{RIGHT, BEND_L, PIPE_VERTICAL, false},
		{RIGHT, BEND_L, BEND_L, false},
		{RIGHT, BEND_L, BEND_J, true},
		{RIGHT, BEND_L, BEND_7, true},
		{RIGHT, BEND_L, BEND_F, false},
		{RIGHT, BEND_L, GROUND, false},
		{RIGHT, BEND_L, STARTING_POS, false},
		{RIGHT, BEND_J, PIPE_HORIZONTAL, false},
		{RIGHT, BEND_J, PIPE_VERTICAL, false},
		{RIGHT, BEND_J, BEND_L, false},
		{RIGHT, BEND_J, BEND_J, false},
		{RIGHT, BEND_J, BEND_7, false},
		{RIGHT, BEND_J, BEND_F, false},
		{RIGHT, BEND_J, GROUND, false},
		{RIGHT, BEND_J, STARTING_POS, false},
		{RIGHT, BEND_7, PIPE_HORIZONTAL, false},
		{RIGHT, BEND_7, PIPE_VERTICAL, false},
		{RIGHT, BEND_7, BEND_L, false},
		{RIGHT, BEND_7, BEND_J, false},
		{RIGHT, BEND_7, BEND_7, false},
		{RIGHT, BEND_7, BEND_F, false},
		{RIGHT, BEND_7, GROUND, false},
		{RIGHT, BEND_7, STARTING_POS, false},
		{RIGHT, BEND_F, PIPE_HORIZONTAL, true},
		{RIGHT, BEND_F, PIPE_VERTICAL, false},
		{RIGHT, BEND_F, BEND_L, false},
		{RIGHT, BEND_F, BEND_J, true},
		{RIGHT, BEND_F, BEND_7, true},
		{RIGHT, BEND_F, BEND_F, false},
		{RIGHT, BEND_F, GROUND, false},
		{RIGHT, BEND_F, STARTING_POS, false},
		{RIGHT, GROUND, PIPE_HORIZONTAL, false},
		{RIGHT, GROUND, PIPE_VERTICAL, false},
		{RIGHT, GROUND, BEND_L, false},
		{RIGHT, GROUND, BEND_J, false},
		{RIGHT, GROUND, BEND_7, false},
		{RIGHT, GROUND, BEND_F, false},
		{RIGHT, GROUND, GROUND, false},
		{RIGHT, GROUND, STARTING_POS, false},
		{RIGHT, STARTING_POS, PIPE_HORIZONTAL, true},
		{RIGHT, STARTING_POS, PIPE_VERTICAL, false},
		{RIGHT, STARTING_POS, BEND_L, false},
		{RIGHT, STARTING_POS, BEND_J, true},
		{RIGHT, STARTING_POS, BEND_7, true},
		{RIGHT, STARTING_POS, BEND_F, false},
		{RIGHT, STARTING_POS, GROUND, false},
		{RIGHT, STARTING_POS, STARTING_POS, false},
		{DOWN, PIPE_HORIZONTAL, PIPE_HORIZONTAL, false},
		{DOWN, PIPE_HORIZONTAL, PIPE_VERTICAL, false},
		{DOWN, PIPE_HORIZONTAL, BEND_L, false},
		{DOWN, PIPE_HORIZONTAL, BEND_J, false},
		{DOWN, PIPE_HORIZONTAL, BEND_7, false},
		{DOWN, PIPE_HORIZONTAL, BEND_F, false},
		{DOWN, PIPE_HORIZONTAL, GROUND, false},
		{DOWN, PIPE_HORIZONTAL, STARTING_POS, false},
		{DOWN, PIPE_VERTICAL, PIPE_VERTICAL, true},
		{DOWN, PIPE_VERTICAL, PIPE_HORIZONTAL, false},
		{DOWN, PIPE_VERTICAL, BEND_L, true},
		{DOWN, PIPE_VERTICAL, BEND_J, true},
		{DOWN, PIPE_VERTICAL, BEND_7, false},
		{DOWN, PIPE_VERTICAL, BEND_F, false},
		{DOWN, PIPE_VERTICAL, GROUND, false},
		{DOWN, PIPE_VERTICAL, STARTING_POS, false},
		{DOWN, BEND_L, PIPE_HORIZONTAL, false},
		{DOWN, BEND_L, PIPE_VERTICAL, false},
		{DOWN, BEND_L, BEND_L, false},
		{DOWN, BEND_L, BEND_J, false},
		{DOWN, BEND_L, BEND_7, false},
		{DOWN, BEND_L, BEND_F, false},
		{DOWN, BEND_L, GROUND, false},
		{DOWN, BEND_L, STARTING_POS, false},
		{DOWN, BEND_J, PIPE_HORIZONTAL, false},
		{DOWN, BEND_J, PIPE_VERTICAL, false},
		{DOWN, BEND_J, BEND_L, false},
		{DOWN, BEND_J, BEND_J, false},
		{DOWN, BEND_J, BEND_7, false},
		{DOWN, BEND_J, BEND_F, false},
		{DOWN, BEND_J, GROUND, false},
		{DOWN, BEND_J, STARTING_POS, false},
		{DOWN, BEND_7, PIPE_HORIZONTAL, false},
		{DOWN, BEND_7, PIPE_VERTICAL, true},
		{DOWN, BEND_7, BEND_L, true},
		{DOWN, BEND_7, BEND_J, true},
		{DOWN, BEND_7, BEND_7, false},
		{DOWN, BEND_7, BEND_F, false},
		{DOWN, BEND_7, GROUND, false},
		{DOWN, BEND_7, STARTING_POS, false},
		{DOWN, BEND_F, PIPE_HORIZONTAL, false},
		{DOWN, BEND_F, PIPE_VERTICAL, true},
		{DOWN, BEND_F, BEND_L, true},
		{DOWN, BEND_F, BEND_J, true},
		{DOWN, BEND_F, BEND_7, false},
		{DOWN, BEND_F, BEND_F, false},
		{DOWN, BEND_F, GROUND, false},
		{DOWN, BEND_F, STARTING_POS, false},
		{DOWN, GROUND, PIPE_HORIZONTAL, false},
		{DOWN, GROUND, PIPE_VERTICAL, false},
		{DOWN, GROUND, BEND_L, false},
		{DOWN, GROUND, BEND_J, false},
		{DOWN, GROUND, BEND_7, false},
		{DOWN, GROUND, BEND_F, false},
		{DOWN, GROUND, GROUND, false},
		{DOWN, GROUND, STARTING_POS, false},
		{DOWN, STARTING_POS, PIPE_HORIZONTAL, false},
		{DOWN, STARTING_POS, PIPE_VERTICAL, true},
		{DOWN, STARTING_POS, BEND_L, true},
		{DOWN, STARTING_POS, BEND_J, true},
		{DOWN, STARTING_POS, BEND_7, false},
		{DOWN, STARTING_POS, BEND_F, false},
		{DOWN, STARTING_POS, GROUND, false},
		{DOWN, STARTING_POS, STARTING_POS, false},
	}
	for _, tt := range tests {
		testname := fmt.Sprintf("Direction %v From %v To %v allowed %v", tt.direction, tt.from, tt.to, tt.allowed)
		t.Run(testname, func(t *testing.T) {
			ans := CanMove(tt.direction, tt.from, tt.to)
			if !reflect.DeepEqual(ans, tt.allowed) {
				t.Errorf("%v got: %v \n", testname, ans)
			}
		})
	}
...
func TestDayten(t *testing.T) {
	...
	for _, tt := range tests {
		testname := fmt.Sprintf("Dayten(%v) - wanted: %v", tt.in.a[0], tt.res)
		t.Run(testname, func(t *testing.T) {
			ans := Dayten(tt.in)
